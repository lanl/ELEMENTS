...
template <typename NumType>
LegendreProductBasis<NumType>::~LegendreProductBasis() {}
 ...
 */
template <typename NumType>
NumType LegendreProductBasis<NumType>::eval_basis(const SizeType I, 
    const NumType *X) {
 ...
 */
template <typename NumType>
void LegendreProductBasis<NumType>::eval_grad_basis(const SizeType I, 
 ...
 */
template <typename NumType>
NumType LegendreProductBasis<NumType>::eval_approx(const NumType *c, 
    const NumType *X) {
  for (int k = 0; k < N; k++) {
    for (int j = 0; j < N; j++) {
 ...
 */
template <typename NumType>
void LegendreProductBasis<NumType>::eval_grad_approx(const NumType *c, 
...
template class LegendreProductBasis<Real>;
