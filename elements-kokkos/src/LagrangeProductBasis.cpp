...
template <typename NumType>
LagrangeProductBasis<NumType>::~LagrangeProductBasis() {
  delete [] w, C;
}
 ...
 */
template <typename NumType>
NumType LagrangeProductBasis<NumType>::eval_basis(const SizeType I, const NumType *X) {
 ...
 */
template <typename NumType>
void LagrangeProductBasis<NumType>::eval_grad_basis(const SizeType I, 
 ...
 */
template <typename NumType>
NumType LagrangeProductBasis<NumType>::eval_approx(const NumType *c, 
    const NumType *X) {
 ...
 */
template <typename NumType>
void LagrangeProductBasis<NumType>::eval_grad_approx(const NumType *c, 
 ...
 */
template <typename NumType>
void LagrangeProductBasis<NumType>::eval_jac(const NumType *x, const NumType *y, 
 ...
 */
template <typename NumType>
NumType LagrangeProductBasis<NumType>::eval_det_jac(const NumType *x, 
 ...
 */
template <typename NumType>
void LagrangeProductBasis<NumType>::eval_inv_jac(const NumType *x, const NumType *y, 
...
template class LagrangeProductBasis<Real>;
template class LagrangeProductBasis<Complex>;
